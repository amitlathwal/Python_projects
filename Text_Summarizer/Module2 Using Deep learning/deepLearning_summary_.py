...
if True:
    ...
    try:
        ...
        temp = rbm.test_rbm(dataset = featureMat_normed,learning_rate=0.01, training_epochs=15, batch_size=5,n_chains=9, n_hidden=9)
        ...
        rbm_summary = []
        for i in range(int(rbmarray.shape[0]*0.3)):
